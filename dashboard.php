	...
	<div class="pt-wrapper">
		...
		<div class="pt-dash">
			...
			<div class="pt-body">
				...
				switch ($pg) {
					case 'restaurants':
						include __DIR__ . "/cpanel/restaurants.php";
						break;
					case 'menu':
						include __DIR__ . "/cpanel/menu.php";
						break;
					case 'cuisines':
						include __DIR__ . "/cpanel/cuisines.php";
						break;
					case 'items':
						include __DIR__ . "/cpanel/items.php";
						break;
					case 'plans':
					...
					case 'payments':
						...
						break;
					case 'settings':
						include __DIR__ . "/cpanel/settings.php";
						break;
					case 'pages':
						include __DIR__ . "/cpanel/pages.php";
						break;
					case 'testimonials':
						include __DIR__ . "/cpanel/testimonials.php";
						break;
					case 'reviews':
						include __DIR__ . "/cpanel/reviews.php";
						break;
					case 'orders':
						include __DIR__ . "/cpanel/orders.php";
						break;
					case 'users':
						include __DIR__ . "/cpanel/users.php";
						break;
					case 'withdraw':
						include __DIR__ . "/cpanel/withdraw.php";
						break;
