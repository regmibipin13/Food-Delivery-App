			...
			?>
					<div class="col-3">
						<div class="pt-item">
							...
							<div class="pt-title"><a href="<?= path ?>/restaurants.php?id=<?= $nearby_rs['id'] ?>&t=<?= fh_seoURL($nearby_rs['name']) ?>">
									<h3><?= $nearby_rs['name'] ?></h3>
								</a></div>
				...
				<div class="col-4">
					<div class="pt-post">
						...
						<div class="pt-details">
							...
							<div class="pt-title">
								<h1><a href="<?= path ?>/restaurants.php?id=<?= $rs['restaurant'] ?>&t=<?= fh_seoURL($rs['rname']) ?>"><?= $rs['name'] ?></a></h1>
							</div>
							<div class="pt-info">
